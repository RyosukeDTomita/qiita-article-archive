...
tags:
  ...
  - codecov
private: false
updated_at: '2026-03-15T00:38:41+09:00'
...
4. GitHub Actionsを使い、カバレッジを含むファイルをアップロードする。今回の場合は`build/reports/jacoco/test/jacocoTestReport.xml`が対象になる。
    ...
    ```
5. (GitHub Actions Secretsに`CODECOV_TOKEN`を追加する): 今回は公開リポジトリなので不要だったが、非公開Repositoryの場合には実施が必要
6. README.mdにCodecovのBadges & Graphsにあるurlをコピペする。
